Vue.component('vfilter',{
    props: ['value'],
    template: `
    <form class="menu-search" action="search" @submit.prevent="$emit('sub')">
			<input class="menu-search-input" id="search" type="search" :value="value" @input="onInput">
			<label for="search" class="menu-search-icon">
				<svg class="menu-search-svg"
...
/* <vfilter v-model="userSearch" @sub="onFilter"></vfilter> */